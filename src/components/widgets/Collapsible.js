  ...
  render: function () {
    ...
    return(
      <div className={this.props.classParentString + ' ' + (this.state.isClosed ? this.props.className : this.props.openedClassName)}>
        {(this.props.location && this.props.location === "bottom") ? '' : (<span className={triggerClassName.trim()} onClick={this.handleTriggerClick}>{counter}{trigger}</span>)}
        ...
        {(this.props.location && this.props.location === "bottom") ? (<span className={triggerClassName.trim()} onClick={this.handleTriggerClick}>{trigger}</span>) : ''}
      </div>
    );
  }
});
